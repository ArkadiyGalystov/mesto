...
const createItemCard = (cardData) => {
  ...
  const sliderImg = document.querySelector('.slider__image-popup');// картинка на весь экран
  const sliderText = document.querySelector('.slider__text');// название под картинкой
